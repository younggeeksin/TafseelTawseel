...
export const sign_up = (args) => {
	return new Promise((resolve, reject) => {
		// console.log('WService :: sign_up :: Promise :: ',resolve, reject);
		// console.log('WService :: sign_up :: args :: ',args);
		wservice.sign_up(args)
		.then((response) => {
			// console.log('WService :: sign_up :: resp :: ',response)
...
export const sign_in = (args) => {
	return new Promise((resolve, reject) => {
		// console.log('WService :: sign_in :: Promise :: ',resolve, reject);
		// console.log('WService :: sign_in :: args :: ',args);
		wservice.sign_in(args)
		.then((response) => {
			// console.log('WService :: sign_in :: resp :: ',response)
			if (response.statusCode == 200) {
				resolve(response.body)
			}
			else {
...
export const update_profile = (args) => {
	return new Promise((resolve, reject) => {
		// console.log('WService :: update_profile :: Promise :: ',resolve, reject);
		// console.log('WService :: update_profile :: args :: ',args);
		wservice.update_profile(args)
		.then((response) => {
			// console.log('WService :: update_profile :: resp :: ',response)
			if (response.statusCode == 200) {
				resolve(response.body)
			}
			else {
...
// 					reject(tr('Email or password is incorrect'))
// 				} else {
